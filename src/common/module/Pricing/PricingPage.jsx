      ...
      <div className="w-full">
        <div className="w-full max-sm:mt-10 mt-10 z-[9] flex-col items-center flex justify-center ">
          <div className="w-full bg-[#E8E8E8] px-5 py-8 rounded-3xl flex justify-center items-center">
            <H1
              title="Transparent Pricing for Transformative AI Solutions."
              className="!text-2xl lg:!text-5xl w-full lg:w-[80%] font-semibold !text-center justify-center items-center"
              textColor="normal"
            />
          </div>
        </div>
