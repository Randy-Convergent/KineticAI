      ...
      <div className="w-full gap-5 grid lg:grid-cols-2 ">
        <ComponentTransition className="w-full h-auto lg:h-[550px] overflow-hidden flex flex-col justify-start items-start px-5 lg:px-10   py-10 lg:py-20 bg-gradient-to-b from-[#141414] to-[#141414] rounded-3xl">
          ...
          <H1
            ...
            title="It all began with a vision to empower businesses through intelligent automation."
            textColor="white"
          />
          <H1
            className="md:mt-5 mt-10  !justify-start !text-base text-start "
            title="We witnessed countless businesses hindered by manual processes and untapped data. Our mission became clear: to develop bespoke AI solutions that drive efficiency, unlock powerful insights, and pave the way for sustainable growth."
            textColor="normal"
          />
